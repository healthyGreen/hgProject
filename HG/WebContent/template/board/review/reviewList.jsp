   ...
   <table width="100%" class="board-type01" style="width:1100px;margin:0 auto ; padding:30px 0;">
                  ...
                  <form name="searchBox"  method="post">
                     <div style="width: 310px; margin: 0 auto; ">
                        <select class="border" name="forSearch" style="height: 30px; border: 1px solid #f0f0f0;">
                           <option value="writer">작성자</option>
                           <option value="content">내용</option>
                           <option value="title">제목</option>   
                        </select>
                        <s:textfield name="search" theme="simple" value="" cssStyle="width:200px; height: 30px; border: 1px solid #f0f0f0 !important;" maxlength="20" />
                        <input class="click" type="submit" value="검색" name="submit" style="background:#484647; border: none; color: #fff;     padding: 5.5px 10px;">
                     </div>
                  </form>
