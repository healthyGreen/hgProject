...
public class goodsWriteAction extends ActionSupport implements SessionAware {
    ...
    * getNo()); resultClass.setSubject("[답변] " + resultClass.getSubject());
   ...
   public String execute() throws Exception {
       ...
       * private int g_number; //상품코드 private String g_name; // 상품명 private
       * String g_content; // 상품설명 private String g_info; private String
